...
const colors = {
  primaryBrand: tokenColors.caramelSwatch as RequiredColorSwatch, // external
  secondaryBrand: tokenColors.darkTealSwatch as RequiredColorSwatch, // external
  accent: tokenColors.beigeSwatch as RequiredColorSwatch, // external
  ...
  grayScale: tokenColors.baseGraySwatch as RequiredColorSwatch, // the primaryBrand and secondaryBrand colors generate grays that are too light in this theme
...
type StreamMarketingColors = {
  colors: typeof colors
}
type StreamMarketingConcepts = Omit<Concepts, 'colors'> & StreamMarketingColors

export const concepts: StreamMarketingConcepts = {
  colors: { ...colors },
  radius: {
    none: radius.none,
    small: radius.small,
