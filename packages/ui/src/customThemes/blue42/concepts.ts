...
const colors = {
  primaryBrand: tokenColors.brightBlueSwatch as RequiredColorSwatch, // external
  secondaryBrand: tokenColors.tealSwatch as RequiredColorSwatch, // external
  accent: tokenColors.brightGreenSwatch as RequiredColorSwatch, // external
  ...
  grayScale: tokenColors.baseGraySwatch, // the primaryBrand and secondaryBrand colors generate grays that are too light in this theme
...
type Blue42Concepts = Omit<Concepts, 'colors'> & Blue42Colors

export const concepts: Blue42Concepts = {
  colors: { ...colors },
  radius: {
    none: radius.none,
    small: radius.small,
