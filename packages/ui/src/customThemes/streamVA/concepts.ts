...
const colors = {
  primaryBrand: tokenColors.aquaSwatch as RequiredColorSwatch, // external
  secondaryBrand: tokenColors.darkBlueSwatch as RequiredColorSwatch, // external
  accent: tokenColors.tealSwatch as RequiredColorSwatch, // external
...
type StreamVAConcepts = Omit<Concepts, 'colors'> & StreamVAColors

export const concepts: StreamVAConcepts = {
  colors: { ...colors },
  radius: {
    none: radius.none,
    small: radius.small,
