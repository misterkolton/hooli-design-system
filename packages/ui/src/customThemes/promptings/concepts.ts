...
const colors = {
  primaryBrand: tokenColors.tealSwatch as RequiredColorSwatch, // external
  secondaryBrand: tokenColors.darkBlueSwatch as RequiredColorSwatch, // external
  accent: tokenColors.accentBlueSwatch as RequiredColorSwatch, // external
  ...
  background: tokenColors.BASE, // external
  foreground: tokenColors.WHITE, // external
  grayScale: tokenColors.graySwatch as RequiredColorSwatch, // the primaryBrand and secondaryBrand colors generate grays that are too light in this theme
  blueScale: tokenColors.lightBlueSwatch as RequiredColorSwatch,
...
type PromptingsColors = {
  colors: typeof colors
}
type PromptingsConcepts = Omit<Concepts, 'colors'> & PromptingsColors

export const concepts: PromptingsConcepts = {
  colors: { ...colors },
  radius: {
    none: radius.none,
    small: radius.small,
