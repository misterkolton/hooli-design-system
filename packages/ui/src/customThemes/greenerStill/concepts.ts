...
const colors = {
  primaryBrand: tokenColors.brightGreenSwatch as RequiredColorSwatch, // external
  secondaryBrand: tokenColors.lightBlueSwatch as RequiredColorSwatch, // external
  accent: tokenColors.copperSwatch as RequiredColorSwatch, // external
  ...
  grayScale: tokenColors.baseGraySwatch as RequiredColorSwatch,
...
//
export type GreenerStillColors = {
  colors: typeof colors
}
type GreenerStillConcepts = Omit<Concepts, 'colors'> & GreenerStillColors

export const concepts: GreenerStillConcepts = {
  colors: { ...colors },
  radius: {
    none: radius.none,
    small: radius.small,
