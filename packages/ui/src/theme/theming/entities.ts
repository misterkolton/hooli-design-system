import { concepts } from '../theming/concepts'
...
const inputs = {
  checkbox: {
    ...
    unCheckedBackgroundColor: concepts.colors.grayScale._1000,
...
const avatar = {
  ...
  bubbleBackgroundColors: {
    isActive: concepts.colors.success._600,
    default: concepts.colors.grayScale._1000,
  },
...
const separator = {
  border: borders.default,
  color: concepts.colors.grayScale._1000,
}
