...
export const MEDIUM_PLUS_FONT = computeFontSize(1.125) + BASE_UNITS
export const LARGE_FONT = computeFontSize(1.5) + BASE_UNITS
export const XLARGE_FONT = computeFontSize(2) + BASE_UNITS
export const XXLARGE_FONT = computeFontSize(4) + BASE_UNITS
...
export const HEADING_FONT_FAMILY = "'Montserrat', sans-serif"
export const BODY_FONT_FAMILY = "'Montserrat', sans-serif"

export const HEADING_FONT_IMPORT =
  'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&display=swap'
export const BODY_FONT_IMPORT =
  'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&display=swap'

export const WEIGHT_THIN = 300
export const WEIGHT_REGULAR = 400
export const WEIGHT_SEMI_BOLD = 500
