...
const colors = {
  primaryBrand: tokenColors.darkBlueSwatch as RequiredColorSwatch, // external
  secondaryBrand: tokenColors.goldSwatch as RequiredColorSwatch, // external
  accent: tokenColors.orangeSwatch as RequiredColorSwatch, // external
...
type PromptingUColors = {
  colors: typeof colors
}
type PromptingUConcepts = Omit<Concepts, 'colors'> & PromptingUColors

export const concepts: PromptingUConcepts = {
  colors: { ...colors },
  radius: {
    none: radius.none,
    small: radius.small,
