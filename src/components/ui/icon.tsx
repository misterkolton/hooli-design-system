...
// Map legacy names to Lucide components
const ICONS = {
  // basics
  close: X,
...
export const Icon: React.FC<IconProps> = ({
  ...
  tone,
  primaryColor,
  secondaryColor, // not used by lucide icons but accepted for legacy parity
  orientation,
  strokeWidth = 2,
  decorative,
  className,
...
export const ICON_KEYS = Object.keys(ICONS) as Array<keyof typeof ICONS>
