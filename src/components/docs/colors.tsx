...
function useContrast(ref: React.RefObject<HTMLElement>) {
...
function ContrastBadge({ targetRef, mode = 'all' as ContrastView }: { targetRef: React.RefObject<HTMLDivElement>; mode?: ContrastView }) {
